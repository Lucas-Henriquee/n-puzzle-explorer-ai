...
private:
    ...
    State *lower_heuristic; // Ponteiro para o estado com a menor heurística na lista
    bool use_cost; // Flag para indicar se a lista deve usar custo para ordenação
public:
    List(bool use_cost) : size(0), head(nullptr), tail(nullptr), lower(nullptr), lower_heuristic(nullptr), use_cost(use_cost) {}
    ~List();
    ...
    State *get_lower_heuristic() const { return lower_heuristic; } // Método para obter o estado com a menor heurística na lista
