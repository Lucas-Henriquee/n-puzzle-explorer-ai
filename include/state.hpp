...
public:
    State(size_t id, size_t cost, size_t depth, State *parent = nullptr, Board board = Board(3, 3))
        : id(id), cost(cost), depth(depth), board(board), parent(parent), next(nullptr), prev(nullptr) {}
